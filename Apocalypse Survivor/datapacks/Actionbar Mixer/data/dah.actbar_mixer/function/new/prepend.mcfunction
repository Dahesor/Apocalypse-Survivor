...
execute if data storage dah:actbar data[0].content[0] store result score #order dah.actbar.calc run data get storage dah:actbar data[0].content[0].order
...
data modify storage dah:actbar data[0].content prepend from storage dah:actbar new
return 1